...
namespace Platformer
{
    static class Camera
    {
        ...
        {
            TranslationX = -MathHelper.Clamp(myTarget.Position.X - WindowManager.WindowWidth / 2, 0, myLevelSize.Width - WindowManager.WindowWidth);
            TranslationY = -MathHelper.Clamp(myTarget.Position.Y - WindowManager.WindowHeight / 2, 0, myLevelSize.Height - WindowManager.WindowHeight);
