...
namespace Utilities
{
    static class XboxControllerUtility
    {
        ...
        static public double GetOldLeftThumbStickY(PlayerIndex aPlayerIndex)
        {
            switch (aPlayerIndex)
            {
                case PlayerIndex.One:
                    return myOldGamePadStateOne.ThumbSticks.Left.Y;
                case PlayerIndex.Two:
                    return myOldGamePadStateTwo.ThumbSticks.Left.Y;
                case PlayerIndex.Three:
                    return myOldGamePadStateThree.ThumbSticks.Left.Y;
                case PlayerIndex.Four:
                    return myOldGamePadStateFour.ThumbSticks.Left.Y;
            }
            return 0;
        }

        static public bool WasLeftThumbStickYMovedUp(PlayerIndex aPlayerIndex)
        {
            return GetLeftThumbStickY(aPlayerIndex) > ThumbStickSensitivity && GetOldLeftThumbStickY(aPlayerIndex) < ThumbStickSensitivity;
        }
        #endregion
